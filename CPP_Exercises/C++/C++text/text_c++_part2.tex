...
\subsection{プログラミングのためのモデル：大富豪プレーヤの部屋}
...
\EXERCISE{
\verb+Player+ クラスを拡張したサブクラスを新たに定義し，
\verb+follow()+ と必要であれば \verb+approve()+ を改良し，より知的な戦略に基づくプレーヤーを実現せよ．

ただし，他のクラスには一切変更を加えないこと．
...
自分で作成した \verb+Player+ クラスのサブクラス以外の変更をしないこと．
