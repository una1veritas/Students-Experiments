...
Vector2::Vector2(double x0, double y0)
{
	...
	printf("/* Vector2(double x0, double y0 */");
}
...
//
// Vector2::dotp() - 自身のベクトルとベクトル u との内積を求める
//
double Vector2::dotp(Vector2 u)
{
	double ret;
...
//
// Vector2::crop() - 自身のベクトルとベクトル u との外積を求める
//
double Vector2::crop(Vector2 u)
{
	double ret;
...
Vector2::Vector2(const Vector2 & v)
{
	...
	printf("/* Vector2(const Vector2 & v) */");
}
