...
//
// double::innerProduct() - 自身のベクトルとベクトルuとの内積を求める
//
double Vector2::innerProduct(Vector2 u) 
{
         double ret;
...
//
// double::innerProduct() - 自身のベクトルとベクトルuとの外積を求める
//
 double Vector2::crossProduct(Vector2 u) 
{
         double ret;
